    ...
    function doSubmit(data){     
        async function doSignUp() {
          try {
            ...
            const response = await post('/api/Signup', {Username: data.username, Password: encryptedPassword, Email: data.email, FirstName: data.firstName, LastName: data.lastName}); 
